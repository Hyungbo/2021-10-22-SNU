...
- 10:00 ~ 12:00  
  **Hamin Chang**	(SNU) Gaussian process regression of dynamical systems (video link = TBA)  
  **Soojeong Hyeon** (SNU)	Distributed orientation estimation in SO(n) with local position measurements (video link = TBA)  
  **Jeong Mo Seong** (SNU) Distributed quantile solver with plug-and-play operation (video link = TBA)
